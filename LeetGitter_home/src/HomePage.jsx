    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-slate-50 py-12 px-6 lg:px-24">
      ...
      <main className="max-w-6xl mx-auto mt-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        ...
        <section className="space-y-6">
          ...
          {/* NEW SECTION: How It Works (moved here) */}
          <motion.div
          ...
          >
            ...
            <ul className="list-disc pl-5 text-slate-600 mt-3 space-y-2 text-sm">
        ...
        <section className="space-y-6">
          ...
          >
            ...
            <p className="text-slate-600 mt-3">
              After installing the extension, follow these quick steps to get
              started:
            </p>
            <ul className="list-disc pl-5 text-slate-600 mt-3 space-y-2 text-sm">
              <li>
                Click the <strong>Extensions</strong> icon in your Chrome
                toolbar.
              </li>
              <li>
                Find <strong>LeetGitter</strong> and click the{" "}
                <LiaThumbtackSolid className="inline text-blue-500" />{" "}
                <strong>Pin</strong> button to keep it visible.
              </li>
              <li>
                Open the extension and click{" "}
                <strong>
                  <FaGithub className="inline text-gray-800" /> Log in with
                  GitHub
                </strong>{" "}
            ...
            <p className="text-slate-500 text-sm mt-3">
              Once logged in, LeetGitter will automatically sync your accepted
              LeetCode solutions to your GitHub repository.
            </p>
          </motion.div>
...
function FeatureCard({ title, desc }) {
  return (
    <div className="p-4 bg-white rounded-xl shadow-sm hover:shadow transition">
